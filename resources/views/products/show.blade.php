    ...
    <div class="max-w-screen-xl px-4 mx-auto 2xl:px-0">
      <div class="lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
        <div class="shrink-0 max-w-md lg:max-w-lg mx-auto">
          <img class="w-full rounded" src="{{ asset('storage/' . $product->photo) }}" alt="{{ $product->name }}" />
        </div>
        ...
        <div class="mt-6 sm:mt-8 lg:mt-0">
          ...
          <div class="mt-6 sm:gap-4 sm:items-center sm:flex sm:mt-8">
                <form action="/add-to-cart/{{ $product->slug }}" method="post">
                    @csrf
                    <button type="submit" class="text-white mt-4 sm:mt-0 bg-orange-500 hover:bg-orange-600 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 dark:bg-orange-500 dark:hover:bg-orange-600 focus:outline-none dark:focus:ring-orange-500 flex items-center justify-center" role="button">
